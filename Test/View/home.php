        ...
        <div class="fake-body"> 
            <div class="container">
                ...
                <div class="partition1">
                    <p class="description1">Body Mass Index (BMI) is a screening tool that uses height and weight to estimate a person's leanness or corpulence, as it is intended to quantify tissue mass. It is widely used as a general indicator of whether a person has a healthy body weight for their height. Specifically, the resulting BMI score is used to categorize whether a person is underweight, normal weight, overweight, or obese based on predefined ranges. </p>
                    <p class="description2">These ranges of BMI vary based on factors such as region and age, and are sometimes further divided into subcategories such as severely underweight or very severely obese. Both underweight and overweight conditions can have health consequences. While BMI is an imperfect measure of healthy body weight, it is a useful indicator of whether any additional testing or action is required. Refer to the tables below the calculator to see the different categories based on BMI that are used by the calculator.</p>
                </div>
                ...
                <div class="formule">
                    <h2>BMI Formula</h2>
                    <p>Below are the equations used for calculating Body Mass Index (BMI) in the International System of Units (SI) and the US customary system (USC) using a 5'10", 160-pound individual as an example:</p>
                    <br>
                    <h3>USC Units:</h3>
                    <p>BMI = 703 * mass (lbs) / height<sup>2</sup> (in) = 703 * 160 / 70<sup>2</sup> = 22.96 kg/m<sup>2</sup></p>
