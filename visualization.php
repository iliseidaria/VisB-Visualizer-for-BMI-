...
<body>
    <main>
        <div class="fake-body">
            <div class="container">
                ...
                <!-- Formular Bar Chart -->
                <form id="barChartForm" class="chart-form" style="display: block;" method="GET" action="bar_chart.php" target="chartFrame">
                ...
                <!-- Formular Geo Chart -->
                <form id="geoChartForm" class="chart-form" style="display: none;" method="GET" action="geo_chart.php" target="chartFrame">
                ...
                <!-- Formular Line Chart -->
                <form id="lineChartForm" class="chart-form" style="display: none;" method="GET" action="line_chart.php" target="chartFrame">
                ...
                <div class="results">
                    <iframe id="chartFrame" name="chartFrame" src="bar_chart.php?year=2008" style="width: 100%; height: 800px; border: none;"></iframe>
                </div>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        document.getElementById('BarChartButton').addEventListener('click', function() {
            ...
            updateChartWithGetParams('bar_chart.php', year, bmiCategory);
        });
        ...
        document.getElementById('GeoChartButton').addEventListener('click', function() {
            ...
            updateChartWithGetParams('geo_chart.php', year, bmiCategory);
        });
        ...
        document.getElementById('LineChartButton').addEventListener('click', function() {
            ...
            updateChartWithGetParams('line_chart.php', null, bmiCategory);
        });
